...
export default {
    ...
    data() {
        return {
            data: [],
            aus_20_years_chart: null,
            string:'Unemployment rate, Australia',
    ...
    mounted() {
        const aus_20_years_chart = Highcharts.chart('aus-20years-container',{
            title: {
                text: 'Unemployment rate, Australia',
                x: -20 //center
            },
            subtitle: {
                text: 'Source: abs.gov.au',
                x: -20
            },
            xAxis: {
